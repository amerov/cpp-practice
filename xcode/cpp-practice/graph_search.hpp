...
//            func(begin);
//            visited.insert(0,begin);            
//            _recursive_breath_first_search(graph, begin, visited, func);
//        }
        
        
    private:
        
//        static void _recursive_breath_first_search(GRAPH& graph, const DATA& cur, ALList<DATA>& visited, TraverseFunc& func){
...
//                _recursive_breath_first_search(graph, traveseList[i], visited, func);
//        }
